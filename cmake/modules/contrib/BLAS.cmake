...
elseif(USE_BLAS STREQUAL "mkl")
  ...
  if(APPLE)
    find_library(BLAS_LIBRARY mklml ${USE_MKL_PATH}/lib/ ${USE_MKL_PATH}/lib/intel64)
  elseif(UNIX)
    find_library(BLAS_LIBRARY mklml_gnu mklml_intel ${USE_MKL_PATH}/lib/ ${USE_MKL_PATH}/lib/intel64)
   endif()
